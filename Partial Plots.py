...
pdp_inter1 = pdp.pdp_interact(model=first_model,dataset=val_X,model_features=base_features,features=features_to_plot)
pdp.pdp_interact_plot(pdp_interact_out=pdp_inter1, feature_names=features_to_plot, plot_type='contour')
plt.show()
...
pdp.pdp_plot(pdp_dist, feat_name)
plt.show()
#the partial dependence plot became smaller
...
#Create a dataset with 2 features and a target, such that the pdp of the first feature is flat, but its permutation importance is high. 
import eli5
